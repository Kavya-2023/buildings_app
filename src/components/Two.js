...
function Two(){
    ...
    <div className="property-card">
       ...
       <div className='details-container'>
        <p className='location'><FontAwesomeIcon icon={faMapMarker} className='l-icon'/>8558 Parker Rd</p>
        <h4 className='heading'>Costco Wholesale-1021 Oak Forest Ln,Myrtle beach,SC</h4>
